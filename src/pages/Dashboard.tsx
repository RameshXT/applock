...
export const Dashboard = ({
  ...
  const handleBulkUnlock = () => {
    const appsToUnlock = lockedApps.filter((app) =>
        ...
        <AnimatePresence>
          {(showUpdateSuccess || toast.visible) && (
            <motion.div
              ...
              className={clsx(
                styles.successToast,
                toast.type === "lock" && styles.toastLock,
                toast.type === "unlock" && styles.toastUnlock
              )}
            >
        ...
        <div className={styles.headerActions}>
          ...
          <div className={styles.combinedActions}>
            <button
              className={clsx(
                styles.actionBtn,
                isScanning && styles.refreshBtnRotating
              )}
              onClick={refreshApps}
            ...
            return (
              <div className={styles.dividerControls}>
                <span className={styles.dividerText}>
                  {count === 0
                    ? "No Apps Found"
                    : `${count} ${count === 1 ? "App" : "Apps"} Found`}
                </span>
                {activeTab === "all" && count > 0 && (
                  <button
                    className={clsx(
                      styles.selectionToggle,
                      selectionMode && styles.selectionToggleActive
                    )}
                    onClick={() => {
      ...
      <main className={styles.mainScrollArea}>
        {activeTab === "home" ? (
          ...
          >
            ...
            <div className={styles.minimalStats}>
              <div className={styles.minStat}>
                {isScanning ? (
                  ...
                  <span className={styles.minStatValue}>{allApps.length}</span>
                )}
            ...
            <button
              className={styles.minimalAction}
              onClick={() => setActiveTab("system")}
            >
              Start Protection
            </button>
                    ...
                    >
                      ...
                      <div className={styles.appIconContainer}>
                        {app.icon ? (
                          ...
                          <div className={styles.appIconFallback}>
                            <Monitor size={20} opacity={isLocked ? 0.9 : 0.3} />
                          </div>
                        )}
                      </div>
                      <div className={styles.appInfo}>
                        ...
                        <div className={styles.appPath}>
                          {(app as any).exec_name || (app as any).path}
                        </div>
                      </div>
                      <div className={styles.lockIndicator}>
                        {isLocked ? (
                          ...
                          <Unlock size={18} style={{ opacity: 0.2 }} />
                        )}
                      </div>
                    </motion.div>
                  );
        ...
        {selectionMode && selectedNames.size > 0 && (
          ...
          >
            ...
            <div className={styles.bulkActionButtons}>
              <button
                className={styles.bulkUnlockBtn}
