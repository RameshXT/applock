    ...
    <section className={styles.settingsGroup}>
          ...
          <div className={styles.pillSwitch}>
            <button
              className={clsx(
                ...
                authMode === "PIN" && styles.pillSwitchBtnActive
              )}
            ...
            <button
              className={clsx(
                styles.pillSwitchBtn,
                authMode === "Password" && styles.pillSwitchBtnActive
              )}
      ...
      <div className={styles.settingRow}>
        <div className={styles.settingLabel}>
          ...
          <span>
            Update your {authMode} to keep your {appName} secure.
          </span>
        </div>
        <div className={styles.settingControl}>
          <button
      ...
      <div className={styles.settingRow}>
        ...
        <div className={styles.settingControl}>
          <div
            ...
            title="Windows Hello support coming soon"
          >
            <button className={clsx(styles.pillSwitchBtn)} disabled>
              ON
            </button>
            <button
              className={clsx(styles.pillSwitchBtn, styles.pillSwitchBtnActive)}
              disabled
            >
              OFF
            </button>
      ...
      >
        ...
        >
          ...
          <span>
            Last Changed:{" "}
            {config.last_credential_change
              ? new Date(config.last_credential_change).toLocaleDateString()
              : "Never"}
          </span>
        </div>
      </div>
